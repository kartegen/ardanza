				...
				<div class="card">
					...
					<div class="card-body mt-4 wow bounceInDown" data-wow-delay=".25s">
						...
						<p class="card-text">El programa Neon Steps Now de Ardanza est�
							dise�ado para j�venes de 12 a�os en adelante, que tengan interés
						...
						<p class="card-text">Nuestro objetivo principal es desarrollar en
							...
							artísticamente de una manera creativa, a trav�s de la enseñanza
				...
				<div class="col-md-3 footer1 d-flex wow bounceInLeft"
					...
					<div class="d-flex flex-wrap align-content-center">
						...
						<p>Desarrollar e impulsar a bailarines por medio de diversas
							disciplinas dancísticas a trav�s de la metodolog�a
							te�rico-pr�ctica.</p>
						<p>
