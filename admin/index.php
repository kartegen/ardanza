		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="#"><i class="icon-th icon-white"></i> Seccion 2</a></li>
					<li><a href="#"><i class="icon-th icon-white"></i> Seccion 3</a></li>
					<li><a href="user.php"><i class="icon-user icon-white"></i> <?= $user['email'];?></a></li>
					 <li>   </li>
...
<!-- 			</div> -->
			...
			<div class="col-sm-3 col-lg-3">
				...
				<!-- SERVER UPTIME -->
				<div class="half-unit">
					<dtitle>Tiempo del servidor</dtitle>
					<hr>
					<div class="cont">
						<p>
...
<!-- 						<div class="window"> -->
<!-- 							<ul class="mail"> -->
<!-- 								<li><i class="unread"></i> <img class="avatar" -->
<!-- 									src="images/photo01.jpeg" alt="avatar"> -->
<!-- 									<p class="sender">Adam W.</p> -->
<!-- 									<p class="message"> -->
<!-- 										<strong>Working</strong> - This is the last... -->
<!-- 									</p> -->
<!-- 									<div class="actions"> -->
<!-- 										<a><img -->
<!-- 											src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/undo.png" -->
<!-- 											alt="reply"></a> <a><img -->
<!-- 											src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/star_fav.png" -->
<!-- 											alt="favourite"></a> <a><img -->
<!-- 											src="http://png-4.findicons.com/files//icons/2232/wireframe_mono/16/tag.png" -->
<!-- 											alt="label"></a> <a><img -->
<!-- 											src="http://png-4.findicons.com/files//icons/2232/wireframe_mono/16/trash.png" -->
<!-- 											alt="delete"></a> -->
<!-- 									</div></li> -->
<!-- 								<li><i class="read"></i> <img class="avatar" -->
<!-- 									src="images/photo02.jpg" alt="avatar"> -->
<!-- 									<p class="sender">Dan E.</p> -->
<!-- 									<p class="message"> -->
<!-- 										<strong>Hey man!</strong> - You have to taste ... -->
<!-- 									</p> -->
<!-- 									<div class="actions"> -->
<!-- 										<a><img -->
<!-- 											src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/undo.png" -->
...
<!-- 									</div></li> -->
<!-- 								<li><i class="read"></i> <img class="avatar" -->
<!-- 									src="images/photo03.jpg" alt="avatar"> -->
<!-- 									<p class="sender">Leonard N.</p> -->
<!-- 									<p class="message"> -->
<!-- 										<strong>New Mac :D</strong> - So happy with ... -->
<!-- 									</p> -->
<!-- 									<div class="actions"> -->
<!-- 										<a><img -->
<!-- 											src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/undo.png" -->
...
<!-- 									</div></li> -->
<!-- 								<li><i class="read"></i> <img class="avatar" -->
<!-- 									src="images/photo04.jpg" alt="avatar"> -->
<!-- 									<p class="sender">Peter B.</p> -->
<!-- 									<p class="message"> -->
<!-- 										<strong>Thank you</strong> - Finally I can ... -->
<!-- 									</p> -->
<!-- 									<div class="actions"> -->
<!-- 										<a><img -->
<!-- 											src="http://png-1.findicons.com/files//icons/2232/wireframe_mono/16/undo.png" -->
...
<!-- 							<i class="graph-arrow"></i> <span class="graph-info-big">634.39</span> -->
...
<!-- 						<br> -->
<!-- 						<p> -->
<!-- 							<img src="images/up-small.png" alt=""> 12% Compared Last Month -->
<!-- 						</p> -->
		...
		<div class="row">
					...
					<div class="cont">
						<div class="info-aapl">
							...
							<ul>
								...
								<li><span class="orange" style="height: 100%"></span></li>
								<li><span class="orange" style="height: 85%"></span></li>
								<li><span class="green" style="height: 75%"></span></li>
								<li><span class="green" style="height: 10%"></span></li>
			...
			<div class="col-sm-3 col-lg-3">
				...
				<div class="half-unit">
					...
					<div class="cont">
						...
						<p>
							<img src="images/up-small.png" alt=""> 23.88%
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3 col-lg-3">
				<div class="dash-unit">
					...
					<div class="text">
						<p>
							<b>DAtos de:</b> Datos random de algun lugar <a
								href="www.facebook.com">Facebook</a> Datos
						</p>
						<p>
...
<!-- 					<br> -->
<!-- 					<div class="switch"> -->
<!-- 						<input type="radio" class="switch-input" name="view" value="on" -->
<!-- 							id="on" checked=""> <label for="on" -->
<!-- 							class="switch-label switch-label-off">On</label> <input -->
<!-- 							type="radio" class="switch-input" name="view" value="off" -->
<!-- 							id="off"> <label for="off" class="switch-label switch-label-on">Off</label> -->
<!-- 						<span class="switch-selection"></span> -->
<!-- 					</div> -->
<!-- 					<div class="switch switch-blue"> -->
<!-- 						<input type="radio" class="switch-input" name="view2" -->
<!-- 							value="week2" id="week2" checked=""> <label for="week2" -->
<!-- 							class="switch-label switch-label-off">Week</label> <input -->
<!-- 							type="radio" class="switch-input" name="view2" value="month2" -->
<!-- 							id="month2"> <label for="month2" -->
<!-- 							class="switch-label switch-label-on">Month</label> <span -->
<!-- 							class="switch-selection"></span> -->
<!-- 					</div> -->

<!-- 					<div class="switch switch-yellow"> -->
<!-- 						<input type="radio" class="switch-input" name="view3" value="yes" -->
<!-- 							id="yes" checked=""> <label for="yes" -->
<!-- 							class="switch-label switch-label-off">Yes</label> <input -->
<!-- 							type="radio" class="switch-input" name="view3" value="no" id="no"> -->
<!-- 						<label for="no" class="switch-label switch-label-on">No</label> <span -->
<!-- 							class="switch-selection"></span> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
...
<!-- 									consectetur adipiscing elit. Nulla iaculis mattis lorem.</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!-- 					<hr> -->
<!-- 					<div class="cont2"> -->
<!-- 						<img src="images/user-avatar.jpg" alt=""> <br> <br> -->
<!-- 						<p>Paul Smith</p> -->
<!-- 						<p> -->
...
<!-- 					<hr> -->
<!-- 					<div class="cont"> -->
<!-- 						<a href="#myModal" role="button" class="btnnew" -->
<!-- 							data-toggle="modal">Example Modal Window</a> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
			<!-- Modal -->
...
<!-- 								placeholder="Name"> <input type="text" id="email" name="email" -->
<!-- 								placeholder="Email"> -->
...
<!-- 						<p>Special Thanks to Highcharts, Linecons and Bootstrap for their -->
<!-- 							amazing tools.</p> -->
<!-- 					</div> -->
